...
├── nea-esi/       # Library crate (v0.9.0) - async ESI client with OAuth2 PKCE, rate limiting, pagination
└── nea-esi-cli/   # Binary crate (v0.2.0) - interactive CLI with REPL, multiple output formats
```
