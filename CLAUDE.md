...
├── nea-esi/       # Library crate (v0.7.2) - async ESI client with OAuth2 PKCE, rate limiting, pagination
└── nea-esi-cli/   # Binary crate (v0.1.2) - interactive CLI with REPL, multiple output formats
```
